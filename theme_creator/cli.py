...
def ParseArguments() -> argparse.Namespace:
    ...
    Parser.add_argument("BaseTheme", help="Path to the base .thmx theme archive")
    Parser.add_argument("VariantTheme", help="Path to the variant .thmx theme archive")
    Parser.add_argument("OutputPath", help="Destination path for the combined super theme archive")
